...
<template>
        ...
        <div class="modal__overlay" tabindex="-1" data-micromodal-close>
            <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
                <header class="modal__header">
                    ...
                    <button type="button" class="modal__close" aria-label="Close modal" @click="toggleStatus"></button>
                </header>
    ...
    <button type="button" @click="toggleStatus" href="javascript:;">Open Modal Dialog</button>
</template>
